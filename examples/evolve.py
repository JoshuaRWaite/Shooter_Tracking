...
class Objective(Evaluator):
    ...
    def get_new_config(self, trial):
        ...
        if self.opt.tracking_method == 'strongsort':
        ...
        elif self.opt.tracking_method == 'deepocsort_confirm':
            ...
            conf_gun = trial.suggest_float("conf_gun", 0.05, 0.9)
            overlap_gun = trial.suggest_float("overlap_gun", 0.25, 0.9)
...
def parse_opt():
    ...
    parser.add_argument('--reid-model', type=str, default=WEIGHTS / 'osnet_x0_25_market1501.pt')
